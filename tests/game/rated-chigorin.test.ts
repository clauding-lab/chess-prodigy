...
it("does not assign ratings to unknown Chigorin configurations", () => {
...
for (const level of ["casual", "club", "strong"] as const)
  it.skipIf(CHIGORIN_RATINGS === null)(
    `settles ${level} Chigorin once, keeps replay/rivalry identity and excludes assistance`,
    () => {
