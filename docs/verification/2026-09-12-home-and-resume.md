...
The corrected enabled production build passed all four focused Home browser checks and independent CSS review. [GitHub run 34682454456](https://github.com/clauding-lab/chess-prodigy/actions/runs/34682454456) passed both verification and secret scanning for `75aa166c10379a8ca6151e60113ee84af406224a`.

Deployed v2.2.1 to `/opt/chess-prodigy/releases/2.2.1-20260912-75aa166-home` after a clean target install/build and a fresh consistent backup at 14:09:09 BDT with integrity_check ok. Source archive SHA-256 `eb48392a242b6745b0d61d289172c9433d5ccd90872f9beefec8723f7b5bc373` matched on transfer. Public Home references `index-DmqB0zK7.js` and `index-CucnTj6h.css`; the CSS SHA-256 `752269f280697479fa8b7769f55fd7dc55adfdbbd10af3b0082b4f3dd5849080` matches the server. The JS content is unchanged from v2.2.0 (its filename changed with the associated build graph). Health is ok and the service is active. The earlier release and backup remain preserved.
