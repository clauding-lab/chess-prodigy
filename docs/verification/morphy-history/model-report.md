...
- Direct strict TypeScript checks cover the training tool and historical test. A scoped temporary ESLint configuration applies the repository TypeScript rules directly to the new training tool; direct tool/report Prettier checks pass. Canonical script coverage is deferred to Task 5.
