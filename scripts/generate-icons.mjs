...
const svg='<svg xmlns="http://www.w3.org/2000/svg" width="512" height="512" viewBox="0 0 512 512"><rect width="512" height="512" rx="96" fill="#2f6b3a"/><circle cx="256" cy="256" r="180" fill="#f0d9b5"/><path d="M160 144h48v48h32v-48h32v48h32v-48h48v88l-40 24v80l32 16v24H168v-24l32-16v-80l-40-24z" fill="#3c2a18"/><path d="M224 264h64v72h-64z" fill="#f0d9b5"/></svg>';
